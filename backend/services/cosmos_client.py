...
class CosmosUserStore:
    """
    Azure Cosmos DB client for user profiles and preferences.
    Each document represents one user, keyed by their Google sub (user_id).
    """
    ...
    async def update_user_tokens(
        self, user_id: str, google_tokens: Dict[str, Any]
    ) -> None:
        """Update just the google_tokens field for a user."""
